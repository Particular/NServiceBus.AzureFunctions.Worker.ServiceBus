namespace NServiceBus.AzureFunctions.Worker.Analyzer
{
    ...
    public static class AzureFunctionsDiagnostics
    {
        ...
        internal static readonly DiagnosticDescriptor InvalidEndpointNameError = new(
        ...
        internal static readonly DiagnosticDescriptor InvalidTriggerFunctionNameError = new(
        ...
        internal static readonly DiagnosticDescriptor InvalidBindingExpression = new(
        ...
        internal static readonly DiagnosticDescriptor PurgeOnStartupNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor LimitMessageProcessingToNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor DefineCriticalErrorActionNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor SetDiagnosticsPathNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor MakeInstanceUniquelyAddressableNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor UseTransportNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor OverrideLocalAddressNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor RouteReplyToThisInstanceNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor RouteToThisInstanceNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor MaxAutoLockRenewalDurationNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor PrefetchCountNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor PrefetchMultiplierNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor TimeToWaitBeforeTriggeringCircuitBreakerNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor TransportTransactionModeNotAllowed = new(
        ...
        internal static readonly DiagnosticDescriptor LogDiagnosticsInfo = new(
