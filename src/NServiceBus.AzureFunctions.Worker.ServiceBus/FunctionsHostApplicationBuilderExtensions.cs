...
/// <summary>
/// Provides extension methods to configure a <see cref="IFunctionEndpoint"/> using <see cref="IHostApplicationBuilder"/>.
/// </summary>
public static class FunctionsHostApplicationBuilderExtensions
{
    ...
    // works.
    static void RegisterEndpointFactory(IHostApplicationBuilder builder, string endpointName, Assembly callingAssembly, Action<IConfiguration, ServiceBusTriggeredEndpointConfiguration> configurationCustomization, string connectionString = null)
    {
        var configuration = builder.Configuration;
        var services = builder.Services;

        var triggerAttribute = callingAssembly?.GetCustomAttribute<NServiceBusTriggerFunctionAttribute>();
